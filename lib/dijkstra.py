    ...
    def set_shortest_path(self):
        while self.current_node:
            ...
            for node, weight in self.current_node.links.items():
                ...
                if self.links_from_starting_node[node][0] > weight + self.links_from_starting_node[self.current_node.label][0]:
                    self.links_from_starting_node[node] = weight + self.links_from_starting_node[self.current_node.label][0], self.current_node
